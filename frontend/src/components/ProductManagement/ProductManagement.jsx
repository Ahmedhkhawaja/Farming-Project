  ...
  return (
    ...
    >
      ...
      >
        ...
        {success && (
          <Alert severity="success" sx={{ mb: 2, borderRadius: '8px', backdropFilter: 'blur(5px)' }}>
            {success}
          </Alert>
        )}
        {error && (
          <Alert severity="error" sx={{ mb: 2, borderRadius: '8px', backdropFilter: 'blur(5px)' }}>
            {error}
          </Alert>
        )}
              ...
              <Box sx={{ mb: 3 }}>
                <FormControl fullWidth error={!!formErrors.productCategory} 
                  ...
                  >
                    ...
                    <MenuItem value="new" sx={{ color: '#2e7d32', fontWeight: 600 }}>
                      + Add New Category
                    </MenuItem>
                  </Select>
                ...
                <Table>
                  ...
                  <TableBody>
                    {products.map((product) => (
                      <TableRow key={product._id} hover sx={{ '&:hover': { backgroundColor: 'rgba(46,125,50,0.04)' } }}>
                        <TableCell>
                          <Chip 
